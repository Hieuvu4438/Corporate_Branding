...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-4 font-display text-lg font-bold text-foreground hover:underline transition-all [&[data-state=open]>svg]:rotate-180 text-left cursor-pointer",
        className
      )}
      {...props}
    >
