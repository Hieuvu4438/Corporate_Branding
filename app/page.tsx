...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 w-full overflow-x-hidden bg-background text-foreground">
      ...
      <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden py-32">
        ...
        <div className="absolute inset-0 w-full h-full">
          <img
            ...
            alt="Obsidian Creative Background"
            className="w-full h-full object-cover filter brightness-[0.35] contrast-[1.05] saturate-[0.85] scale-105"
          />
          {/* Radial dark wash overlay */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_10%,oklch(0.12_0.015_250)_85%)]" />
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center space-y-12 flex flex-col items-center">
          ...
          <ScrollReveal delay={300} duration={1000} className="w-full">
            <h1 className="font-display text-5xl font-light tracking-tight text-white sm:text-7xl lg:text-8xl leading-[1.05] text-balance max-w-5xl mx-auto">
          ...
          <ScrollReveal delay={500} duration={1000}>
            <p className="max-w-2xl text-lg sm:text-xl text-muted-foreground/90 font-light leading-relaxed text-balance mx-auto">
          ...
          <ScrollReveal delay={700} duration={1000}>
            <div className="flex flex-col sm:flex-row gap-6 pt-4">
              <Link
                href="/projects"
                className="inline-flex items-center justify-between font-bold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none cursor-pointer bg-primary text-primary-foreground hover:brightness-110 active:scale-[0.98] shadow-button h-14 pl-8 pr-3 rounded-full gap-8 group"
              >
                <span className="tracking-wide">Xem dự án tiêu biểu</span>
                <div className="h-8 w-8 rounded-full bg-black/10 flex items-center justify-center shrink-0 transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
                  <MoveUpRight className="h-4 w-4 text-primary-foreground" />
                </div>
              </Link>
              <Link
                href="/contact"
                className="inline-flex items-center justify-between font-bold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none cursor-pointer border border-border bg-muted/30 backdrop-blur-md text-foreground hover:bg-muted/50 active:scale-[0.98] h-14 pl-8 pr-3 rounded-full gap-8 group"
              >
      ...
      <section className="py-32 md:py-48 border-t border-border/50 relative overflow-hidden bg-background">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <ScrollReveal duration={1000} className="mb-20 text-center max-w-3xl mx-auto space-y-4">
            <h2 className="font-display text-4xl font-light tracking-tight text-white sm:text-6xl text-balance">
          ...
          <div className="grid grid-cols-12 gap-8 grid-flow-dense">
            ...
            <div className="col-span-12 lg:col-span-8 bg-muted border border-border p-2 rounded-[24px] backdrop-blur-md group hover:border-primary/20 transition-colors duration-500">
              <div className="bg-card border border-white/5 p-8 rounded-[18px] shadow-card-subtle backdrop-blur-lg flex flex-col justify-between h-full space-y-8">
                <div className="space-y-4 text-left">
                  <span className="text-[11px] font-bold text-secondary uppercase tracking-widest font-sans">Dự án nổi bật</span>
                  <h3 className="font-display text-2xl md:text-3xl font-light text-white tracking-tight">
                ...
                <div className="relative aspect-[16/9] rounded-[12px] overflow-hidden bg-background/50 border border-border/30">
                  <img
                    ...
                    className="object-cover w-full h-full transition-transform duration-1000 group-hover:scale-105 filter grayscale mix-blend-luminosity brightness-90 group-hover:grayscale-0 group-hover:mix-blend-normal group-hover:brightness-100"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-4 bg-muted border border-border p-2 rounded-[24px] backdrop-blur-md group hover:border-secondary/20 transition-colors duration-500">
              <div className="bg-card border border-white/5 p-8 rounded-[18px] shadow-card-subtle backdrop-blur-lg flex flex-col justify-between h-full text-left space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <span className="block font-display text-5xl font-light text-white">AA</span>
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-4 bg-muted border border-border p-2 rounded-[24px] backdrop-blur-md group hover:border-primary/20 transition-colors duration-500">
              <div className="bg-card border border-white/5 p-8 rounded-[18px] shadow-card-subtle backdrop-blur-lg flex flex-col justify-between h-full text-left space-y-12">
                <div className="h-10 w-10 rounded-full bg-accent flex items-center justify-center text-primary">
                  <Zap className="h-5 w-5" />
                </div>
                <div className="space-y-4">
                  <h4 className="font-display text-xl font-light text-white tracking-tight">Tốc độ & Hiệu năng</h4>
                ...
                <Link
                  href="/services"
                  className="text-xs font-bold text-primary tracking-widest uppercase flex items-center gap-1.5 hover:text-white transition-colors duration-300 font-sans"
                >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-start">
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-28 space-y-6 text-left">
              ...
              <h2 className="font-display text-4xl font-light tracking-tight text-white sm:text-5xl lg:text-6xl leading-tight text-balance">
            ...
            <div className="lg:col-span-7 space-y-12">
              <ScrollReveal delay={100} duration={800}>
                <div className="bg-muted border border-border p-2 rounded-[24px] backdrop-blur-md group hover:border-primary/20 transition-colors duration-500">
                  <div className="bg-card border border-white/5 p-8 rounded-[18px] shadow-card-subtle backdrop-blur-lg flex gap-6 text-left items-start">
                    <div className="h-12 w-12 rounded-full bg-accent flex items-center justify-center text-primary shrink-0">
                      <Compass className="h-6 w-6" />
                    </div>
                    <div className="space-y-2">
                      <h3 className="font-display text-xl font-semibold text-white tracking-tight">Sáng tạo dựa trên Dữ liệu</h3>
                      <p className="text-sm text-muted-foreground font-light leading-relaxed">
              ...
              <ScrollReveal delay={200} duration={800}>
                <div className="bg-muted border border-border p-2 rounded-[24px] backdrop-blur-md group hover:border-secondary/20 transition-colors duration-500">
                  <div className="bg-card border border-white/5 p-8 rounded-[18px] shadow-card-subtle backdrop-blur-lg flex gap-6 text-left items-start">
                    ...
                    <div className="space-y-2">
                      <h3 className="font-display text-xl font-semibold text-white tracking-tight">Xuất sắc trong Chế tác</h3>
                      <p className="text-sm text-muted-foreground font-light leading-relaxed">
              ...
              <ScrollReveal delay={300} duration={800}>
                <div className="bg-muted border border-border p-2 rounded-[24px] backdrop-blur-md group hover:border-primary/20 transition-colors duration-500">
                  <div className="bg-card border border-white/5 p-8 rounded-[18px] shadow-card-subtle backdrop-blur-lg flex gap-6 text-left items-start">
                    ...
                    <div className="space-y-2">
                      <h3 className="font-display text-xl font-semibold text-white tracking-tight">Sự An Tâm làm Kim Chỉ Nam</h3>
                      <p className="text-sm text-muted-foreground font-light leading-relaxed">
      ...
      <section className="py-32 md:py-48 border-t border-border/50 relative overflow-hidden bg-background">
        <div className="absolute inset-0 w-full h-full bg-[radial-gradient(circle_at_center,oklch(0.20_0.02_150_/_0.15)_0%,transparent_60%)]" />
        
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center space-y-10">
          <ScrollReveal duration={800}>
            <h2 className="font-display text-4xl font-light tracking-tight text-white sm:text-6xl lg:text-7xl leading-tight text-balance">
          ...
          <ScrollReveal delay={400} duration={800} className="flex justify-center pt-6">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center font-bold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none cursor-pointer bg-primary text-primary-foreground hover:brightness-110 active:scale-95 shadow-button h-16 px-10 rounded-full gap-4 group text-base"
            >
              <span>Bắt đầu thảo luận ngay</span>
              <div className="h-8 w-8 rounded-full bg-black/10 flex items-center justify-center shrink-0 transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:translate-x-1 group-hover:-translate-y-0.5">
                <MoveUpRight className="h-4 w-4 text-primary-foreground" />
              </div>
            </Link>
          </ScrollReveal>
